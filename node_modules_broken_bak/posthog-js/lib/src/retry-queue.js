...
var RetryQueue = /** @class */ (function () {
    ...
    RetryQueue.prototype.resume = function () {
        var _this = this;
        if (!(0, core_1.isUndefined)(globals_1.window) && 'onLine' in globals_1.window.navigator) {
            ...
            (0, general_utils_1.addEventListener)(globals_1.window, 'online', this._onlineListener);
            (0, general_utils_1.addEventListener)(globals_1.window, 'offline', this._offlineListener);
        }
    };
    ...
    RetryQueue.prototype.retriableRequest = function (_a) {
        ...
        if ((0, core_1.isPositiveNumber)(retriesPerformedSoFar)) {
        ...
        this._instance._send_request(__assign(__assign({}, options), { callback: function (response) {
                ...
                if (response.statusCode !== 200 && (response.statusCode < 400 || response.statusCode >= 500)) {
                    var maxRetries = response.statusCode === 0 ? STATUS_CODE_ZERO_MAX_RETRIES : DEFAULT_MAX_RETRIES;
                    if ((retriesPerformedSoFar !== null && retriesPerformedSoFar !== void 0 ? retriesPerformedSoFar : 0) < maxRetries) {
                        _this._enqueue(__assign({ retriesPerformedSoFar: retriesPerformedSoFar }, options));
                        return;
                    }
                    if (response.statusCode === 0) {
                        logger_1.logger.warn("Request failed before receiving an HTTP response; this can happen due to network issues, CORS, browser blocking, or ad blockers. Stopped retrying after ".concat(retriesPerformedSoFar !== null && retriesPerformedSoFar !== void 0 ? retriesPerformedSoFar : 0, " retries."));
                    }
                }
