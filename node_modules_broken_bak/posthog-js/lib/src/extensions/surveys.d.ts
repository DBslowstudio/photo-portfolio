...
export declare class SurveyManager {
     ...
     */
    checkSurveyDisplayEligibility(survey: Survey): {
        eligible: boolean;
        reason?: string;
    };
    /**
