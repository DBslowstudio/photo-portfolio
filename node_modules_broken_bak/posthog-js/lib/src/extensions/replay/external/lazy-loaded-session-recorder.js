...
exports.LazyLoadedSessionRecording = exports.PENDING_BUFFER_STORAGE_SUFFIX = exports.SESSION_RECORDING_BATCH_KEY = exports.RECORDING_BUFFER_TIMEOUT = exports.RECORDING_MAX_EVENT_SIZE = exports.RECORDING_IDLE_THRESHOLD_MS = exports.splitBuffer = exports.SEVEN_MEGABYTES = exports.RECORDING_REMOTE_CONFIG_TTL_MS = void 0;
var constants_1 = require("../../../constants");
var constants_2 = require("../../../constants");
Object.defineProperty(exports, "RECORDING_REMOTE_CONFIG_TTL_MS", { enumerable: true, get: function () { return constants_2.RECORDING_REMOTE_CONFIG_TTL_MS; } });
...
exports.PENDING_BUFFER_STORAGE_SUFFIX = '_replay_pending_buffer';
...
var LazyLoadedSessionRecording = /** @class */ (function () {
    function LazyLoadedSessionRecording(_instance, documentWasEverVisible) {
        ...
        this._pendingBufferRestored = false;
        ...
        this._onSessionIdCallback = function (sessionId, windowId, changeReason) {
            ...
            (_b = _this._instance.persistence) === null || _b === void 0 ? void 0 : _b.unregister(constants_3.SESSION_RECORDING_FIRST_FULL_SNAPSHOT_TIMESTAMP);
        ...
        this._hasPassedMinimumDuration = function () {
            var _a;
            var persistedSessionId = (_a = _this._instance.persistence) === null || _a === void 0 ? void 0 : _a.props[constants_3.SESSION_RECORDING_PAST_MINIMUM_DURATION];
        ...
        this._isBelowMinimumDuration = function () {
            ...
            if (bufferDuration >= minimumDuration) {
                (_d = _this._instance.persistence) === null || _d === void 0 ? void 0 : _d.register((_a = {},
                    _a[constants_3.SESSION_RECORDING_PAST_MINIMUM_DURATION] = _this._sessionId,
                    _a));
                return false;
            }
            return true;
        ...
        var _a = this._sessionManager.checkAndGetSessionAndWindowId(), sessionId = _a.sessionId, windowId = _a.windowId, sessionStartTimestamp = _a.sessionStartTimestamp;
        ...
        var persistenceName = this._instance.config.persistence_name || this._instance.config.token;
        this._pendingBufferStorageKey = 'ph_' + persistenceName + exports.PENDING_BUFFER_STORAGE_SUFFIX;
    ...
    Object.defineProperty(LazyLoadedSessionRecording.prototype, "_isSampled", {
        get: function () {
            var currentValue = this._instance.get_property(constants_3.SESSION_RECORDING_IS_SAMPLED);
    ...
    LazyLoadedSessionRecording.prototype._activateTrigger = function (triggerType, matchDetail) {
        ...
        try {
            ...
            var persistenceKey = triggerType === 'url'
                ? constants_3.SESSION_RECORDING_URL_TRIGGER_ACTIVATED_SESSION
                : constants_3.SESSION_RECORDING_EVENT_TRIGGER_ACTIVATED_SESSION;
    ...
    Object.defineProperty(LazyLoadedSessionRecording.prototype, "_remoteConfig", {
        get: function () {
            var _a, _b;
            var persistedConfig = this._instance.get_property(constants_3.SESSION_RECORDING_REMOTE_CONFIG);
            if (!persistedConfig) {
                return undefined;
            }
            var parsedConfig;
            ...
            if (!this.isStarted && !this._isRestartingForSessionIdChange) {
                ...
                if (Date.now() - cacheTimestamp > constants_1.RECORDING_REMOTE_CONFIG_TTL_MS) {
                    logger.info('persisted remote config for session recording is stale and will be ignored', {
                        cacheTimestamp: cacheTimestamp,
                        persistedConfig: persistedConfig,
                    });
                    (_b = this._instance.persistence) === null || _b === void 0 ? void 0 : _b.unregister(constants_3.SESSION_RECORDING_REMOTE_CONFIG);
                    return undefined;
                }
            }
            return parsedConfig;
    ...
    LazyLoadedSessionRecording.prototype.start = function (startReason) {
        ...
        if (!this.isStarted) {
            var holdFreshStart = this._isIdle !== false && !this._suppressNextFreshStartHold;
        ...
        var _c = this._sessionManager.checkAndGetSessionAndWindowId(), sessionId = _c.sessionId, windowId = _c.windowId, sessionStartTimestamp = _c.sessionStartTimestamp;
        this._sessionId = sessionId;
        this._windowId = windowId;
        this._sessionStartTimestamp = sessionStartTimestamp;
        ...
        (_a = this._instance.persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_3.SESSION_RECORDING_FIRST_FULL_SNAPSHOT_TIMESTAMP);
        ...
        this._checkOverride(constants_3.SESSION_RECORDING_OVERRIDE_SAMPLING, function () {
            _this.overrideSampling();
        }, function () { var _a; return (_a = _this._instance.persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_3.SESSION_RECORDING_OVERRIDE_SAMPLING); });
        this._checkOverride(constants_3.SESSION_RECORDING_OVERRIDE_LINKED_FLAG, function () {
            _this.overrideLinkedFlag();
        }, function () { var _a; return (_a = _this._instance.persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_3.SESSION_RECORDING_OVERRIDE_LINKED_FLAG); });
        this._checkOverride(constants_3.SESSION_RECORDING_OVERRIDE_EVENT_TRIGGER, function () {
            _this.overrideTrigger('event');
        }, function () { var _a; return (_a = _this._instance.persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_3.SESSION_RECORDING_OVERRIDE_EVENT_TRIGGER); });
        this._checkOverride(constants_3.SESSION_RECORDING_OVERRIDE_URL_TRIGGER, function () {
            _this.overrideTrigger('url');
        }, function () { var _a; return (_a = _this._instance.persistence) === null || _a === void 0 ? void 0 : _a.unregister(constants_3.SESSION_RECORDING_OVERRIDE_URL_TRIGGER); });
    ...
    LazyLoadedSessionRecording.prototype._releaseHoldAfterStop = function () {
        this._setFlushHold(undefined, { preserveLogDedup: this._isRestartingForSessionIdChange });
        this._heldEpochShipsOnUnload = false;
    };
    LazyLoadedSessionRecording.prototype.flushBeforeIdentityReset = function () {
    ...
    LazyLoadedSessionRecording.prototype._setFlushHold = function (reason, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.preserveLogDedup, preserveLogDedup = _c === void 0 ? false : _c;
        this._holdFlushUntilInteraction = !(0, core_1.isUndefined)(reason);
        this._flushHoldReason = reason;
        if ((0, core_1.isUndefined)(reason)) {
        ...
        var holdKey = "".concat(this.sessionId, ":").concat(reason);
        if (holdKey === this._lastLoggedFlushHold) {
            return;
        }
        this._lastLoggedFlushHold = holdKey;
        logger.info("holding buffer: ".concat(reason, ". nothing is uploaded until the user interacts with the page"));
    };
    ...
    LazyLoadedSessionRecording.prototype._processQueuedCompressionEventSync = function (queuedEvent) {
        var _a;
        try {
            var eventToSend = queuedEvent.event;
            var size = (0, sessionrecording_utils_1.estimateSize)(queuedEvent.event);
            if (queuedEvent.compressionEnabled) {
                try {
                    ;
                    (_a = compressEventSync(queuedEvent.event), eventToSend = _a.event, size = _a.size);
                }
                catch (e) {
    ...
    LazyLoadedSessionRecording.prototype.onRRwebEmit = function (rawEvent) {
        ...
        if (rawEvent.type === rrweb_types_1.EventType.FullSnapshot) {
            ...
            (_f = this._instance.persistence) === null || _f === void 0 ? void 0 : _f.register_once((_a = {},
                _a[constants_3.SESSION_RECORDING_FIRST_FULL_SNAPSHOT_TIMESTAMP] = rawEvent.timestamp,
                _a), undefined);
        }
        ...
        if (event.type === rrweb_types_1.EventType.Custom && event.data.tag === json_ld_1.JSON_LD_EVENT_TAG) {
            var href = void 0;
            try {
                href = globals_1.window ? this._maskReplayUrl(globals_1.window.location.href) : undefined;
            }
            catch (_q) {
        ...
        var _r = compressionEnabled
            ? compressEventSync(event)
            : { event: event, size: (0, sessionrecording_utils_1.estimateSize)(event) }, eventToSend = _r.event, size = _r.size;
    ...
    LazyLoadedSessionRecording.prototype.overrideSampling = function () {
        ...
        (_b = this._instance.persistence) === null || _b === void 0 ? void 0 : _b.register((_a = {},
            ...
            _a[constants_3.SESSION_RECORDING_IS_SAMPLED] = this.sessionId,
            _a[constants_3.SESSION_RECORDING_SAMPLE_RATE] = null,
            _a));
        this._tryTakeFullSnapshot();
        this._releaseHoldAndFlush();
    ...
    LazyLoadedSessionRecording.prototype._maybeLogBufferingReason = function (status) {
        ...
        if (status !== triggerMatching_1.BUFFERING) {
            if (!(0, core_1.isUndefined)(this._lastLoggedBufferingReason)) {
                this._instance.register_for_session((_a = {}, _a[constants_3.SDK_DEBUG_REPLAY_PENDING_TRIGGER_CONDITIONS] = [], _a));
            }
        ...
        if (pending.length === 0) {
            if (!(0, core_1.isUndefined)(this._lastLoggedBufferingReason)) {
                this._instance.register_for_session((_b = {}, _b[constants_3.SDK_DEBUG_REPLAY_PENDING_TRIGGER_CONDITIONS] = [], _b));
            }
            this._lastLoggedBufferingReason = undefined;
            return;
        }
        ...
        this._instance.register_for_session((_c = {}, _c[constants_3.SDK_DEBUG_REPLAY_PENDING_TRIGGER_CONDITIONS] = pending, _c));
        logger.info("buffering: ".concat(reason));
    };
    LazyLoadedSessionRecording.prototype._canParkPendingBuffer = function () {
        var _a;
        ...
        return (this._instance.config.persistence !== 'memory' &&
            ((_a = this._instance.persistence) === null || _a === void 0 ? void 0 : _a._disabled) !== true &&
     ...
     */
    LazyLoadedSessionRecording.prototype._parkBufferForNextPage = function () {
        if (this._buffer.data.length === 0 ||
            this._buffer.size === this._lastParkedBufferSize ||
            this._buffer.size > exports.RECORDING_MAX_EVENT_SIZE ||
            !this._canParkPendingBuffer()) {
            return;
        }
        this._lastParkedBufferSize = this._buffer.size;
        storage_1.sessionStore._set(this._pendingBufferStorageKey, this._buffer);
    };
    LazyLoadedSessionRecording.prototype._restorePendingBuffer = function () {
        if (this._pendingBufferRestored || !this._canParkPendingBuffer()) {
            return;
        }
        this._pendingBufferRestored = true;
        var parked = storage_1.sessionStore._parse(this._pendingBufferStorageKey);
        storage_1.sessionStore._remove(this._pendingBufferStorageKey);
        if (!(0, core_1.isObject)(parked) ||
            !(0, core_1.isArray)(parked.data) ||
            parked.data.length === 0 ||
            !(0, core_1.isArray)(parked.sizes) ||
            parked.sizes.length !== parked.data.length ||
            !(0, core_1.isNumber)(parked.size)) {
            return;
        }
    ...
    LazyLoadedSessionRecording.prototype._flushBuffer = function (isUnloading) {
        var _this = this;
        var _a, _b;
        if (isUnloading === void 0) { isUnloading = false; }
        ...
        if (this._wouldOpenRecordingWithMarkersOnly()) {
            ...
            if (this._buffer.size > exports.RECORDING_MAX_EVENT_SIZE) {
        ...
        if (status === triggerMatching_1.BUFFERING || status === triggerMatching_1.PAUSED || status === triggerMatching_1.DISABLED || isBelowMinimumDuration) {
            ...
            // ended here
            if (isUnloading && (status === triggerMatching_1.ACTIVE || status === triggerMatching_1.SAMPLED)) {
                this._parkBufferForNextPage();
            }
            this._scheduleFlushBuffer();
            return this._buffer;
        ...
        if (validatedBuffer.data.length > 0) {
            ...
            if (!(0, core_1.isUndefined)(this._lastParkedBufferSize)) {
                storage_1.sessionStore._remove(this._pendingBufferStorageKey);
    ...
    LazyLoadedSessionRecording.prototype._reportStarted = function (startReason, tagPayload) {
        ...
        this._instance.register_for_session((_a = {},
            _a[constants_3.SESSION_RECORDING_START_REASON] = startReason,
            _a));
    ...
    Object.defineProperty(LazyLoadedSessionRecording.prototype, "sdkDebugProperties", {
        get: function () {
            ...
            return _a = {
                ...
                _a[constants_3.SDK_DEBUG_REPLAY_RRWEB_ATTACHED] = !!this._stopRrweb,
                _a[constants_3.SDK_DEBUG_REPLAY_RRWEB_START_ATTEMPTED] = this._rrwebStartAttempted,
                _a;
        },
        enumerable: false,
        configurable: true
    ...
    LazyLoadedSessionRecording.prototype._startRecorder = function () {
        ...
        if ((userSessionRecordingOptions === null || userSessionRecordingOptions === void 0 ? void 0 : userSessionRecordingOptions.captureJsonLd) === true &&
            ...
            this._jsonLdCapture = (0, json_ld_1.startJsonLdCapture)(globals_1.document, globals_1.window.MutationObserver, {
                maskUrl: function (url) { return _this._maskReplayUrl(url); },
                ...
                isRecordedElement: function (element) { return rrwebRecord.mirror.getId(element) > 0; },
