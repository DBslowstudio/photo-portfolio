...
export declare const PENDING_BUFFER_STORAGE_SUFFIX = "_replay_pending_buffer";
...
export declare class LazyLoadedSessionRecording implements LazyLoadedSessionRecordingInterface {
    ...
    private _flushHoldReason;
    private _lastLoggedFlushHold;
    ...
    private _buffer;
    private readonly _pendingBufferStorageKey;
    private _pendingBufferRestored;
    private _lastParkedBufferSize;
     ...
     */
    private _parkBufferForNextPage;
    private _restorePendingBuffer;
