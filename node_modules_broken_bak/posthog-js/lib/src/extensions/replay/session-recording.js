...
var hasDocumentEverBeenVisible = function () {
    var _a, _b;
    if (!(globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.visibilityState) || globals_1.document.visibilityState === 'visible') {
        return true;
    }
    var visibilityEntries = (_b = (_a = globals_1.window === null || globals_1.window === void 0 ? void 0 : globals_1.window.performance) === null || _a === void 0 ? void 0 : _a.getEntriesByType) === null || _b === void 0 ? void 0 : _b.call(_a, 'visibility-state');
    return !(visibilityEntries === null || visibilityEntries === void 0 ? void 0 : visibilityEntries.length) || visibilityEntries.some(function (entry) { return entry.name === 'visible'; });
};
var SessionRecording = /** @class */ (function () {
    function SessionRecording(_instance) {
        ...
        this._sessionRecordingDisposed = false;
        this._documentWasEverVisible = hasDocumentEverBeenVisible();
        this._onVisibilityChange = function () {
            ...
            if ((globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.visibilityState) === 'visible') {
                ...
                (_b = (_a = _this._lazyLoadedSessionRecording) === null || _a === void 0 ? void 0 : _a.setDocumentWasEverVisible) === null || _b === void 0 ? void 0 : _b.call(_a, true);
            }
        };
    ...
    SessionRecording.prototype.dispose = function (_a) {
        var _b;
        var _c = _a === void 0 ? {} : _a, _d = _c.discardBufferedEvents, discardBufferedEvents = _d === void 0 ? false : _d;
        this._sessionRecordingDisposed = true;
        (_b = globals_1.document === null || globals_1.document === void 0 ? void 0 : globals_1.document.removeEventListener) === null || _b === void 0 ? void 0 : _b.call(globals_1.document, 'visibilitychange', this._onVisibilityChange);
    ...
    SessionRecording.prototype._lazyLoadAndStart = function (startReason) {
        ...
        if (!((_b = (_a = globals_2.assignableWindow === null || globals_2.assignableWindow === void 0 ? void 0 : globals_2.assignableWindow.__PosthogExtensions__) === null || _a === void 0 ? void 0 : _a.rrweb) === null || _b === void 0 ? void 0 : _b.record) ||
            !((_c = globals_2.assignableWindow.__PosthogExtensions__) === null || _c === void 0 ? void 0 : _c.initSessionRecording)) {
            ...
            var sessionManager_1 = this._instance.sessionManager;
            (_e = (_d = globals_2.assignableWindow.__PosthogExtensions__) === null || _d === void 0 ? void 0 : _d.loadExternalDependency) === null || _e === void 0 ? void 0 : _e.call(_d, this._instance, this._scriptName, function (err) {
                var _a;
                if (_this._sessionRecordingDisposed ||
                    !_this._isRecordingEnabled ||
                    _this._instance.sessionManager !== sessionManager_1) {
                    _this._recordingStatus = triggerMatching_1.DISABLED;
                    return;
                }
                if (err) {
                    ...
                    _this._instance.register_for_session((_a = {},
    ...
    SessionRecording.prototype._discardRecording = function (discardProducerEvents) {
        var _a, _b;
        if (discardProducerEvents === void 0) { discardProducerEvents = false; }
        (_a = this._persistFlagsOnSessionListener) === null || _a === void 0 ? void 0 : _a.call(this);
        this._persistFlagsOnSessionListener = undefined;
        (_b = this._lazyLoadedSessionRecording) === null || _b === void 0 ? void 0 : _b.discard({ discardProducerEvents: discardProducerEvents });
    };
    SessionRecording.prototype._resetSampling = function () {
        ...
        (_b = this._persistence) === null || _b === void 0 ? void 0 : _b.unregister(constants_1.SESSION_RECORDING_SAMPLE_RATE);
    };
    ...
    SessionRecording.prototype.onRemoteConfig = function (result) {
        ...
        var response = result.ok ? result.config : undefined;
    ...
    SessionRecording.prototype._isRemoteConfigFresh = function () {
        ...
        if ((0, core_1.isNullish)(config.cache_timestamp)) {
            return false;
        }
        return Date.now() - config.cache_timestamp <= constants_1.RECORDING_REMOTE_CONFIG_TTL_MS;
    };
    SessionRecording.prototype._onScriptLoaded = function (startReason) {
        ...
        if (!((_b = globals_2.assignableWindow.__PosthogExtensions__) === null || _b === void 0 ? void 0 : _b.initSessionRecording)) {
        ...
        if (!this._lazyLoadedSessionRecording) {
            this._lazyLoadedSessionRecording = (_c = globals_2.assignableWindow.__PosthogExtensions__) === null || _c === void 0 ? void 0 : _c.initSessionRecording(this._instance, this._documentWasEverVisible);
        ...
        this._recordingStatus = triggerMatching_1.LAZY_LOADING;
        (_e = (_d = this._lazyLoadedSessionRecording).setDocumentWasEverVisible) === null || _e === void 0 ? void 0 : _e.call(_d, this._documentWasEverVisible);
    ...
    SessionRecording.prototype.flushBeforeIdentityReset = function () {
        var _a, _b;
        (_b = (_a = this._lazyLoadedSessionRecording) === null || _a === void 0 ? void 0 : _a.flushBeforeIdentityReset) === null || _b === void 0 ? void 0 : _b.call(_a);
    };
