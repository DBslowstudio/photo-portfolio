...
exports.clearInProgressSurveyState = exports.isSurveyInProgress = exports.getInProgressSurveyState = exports.setInProgressSurveyState = exports.renderChildrenAsTextOrHtml = exports.useSurveyContext = exports.SurveyContext = exports.hasWaitPeriodPassed = exports.getSurveySeen = exports.canActivateRepeatedly = exports.getDisplayOrderQuestions = exports.getQuestionOrder = exports.getDisplayOrderChoices = exports.shuffle = exports.sendSurveyAbandonedEvent = exports.dismissedSurveyEvent = exports.sendSurveyEvent = exports.retrieveSurveyShadow = exports.addSurveyCSSVariablesToElement = exports.defaultSurveyAppearance = exports.getSurveyResponseKey = void 0;
...
var url_targeting_utils_1 = require("@posthog/browser-common/utils/url-targeting-utils");
var storage_1 = require("../../storage");
var constants_1 = require("../../constants");
var stylesheet_loader_1 = require("@posthog/browser-common/utils/stylesheet-loader");
...
var matcher_utils_1 = require("@posthog/browser-common/utils/matcher-utils");
...
var sendSurveyEvent = function (_a) {
    var _b, _c, _d;
    var _e;
    var responses = _a.responses, survey = _a.survey, surveySubmissionId = _a.surveySubmissionId, posthog = _a.posthog, isSurveyCompleted = _a.isSurveyCompleted, properties = _a.properties, surveyLanguage = _a.surveyLanguage, questionSnapshots = _a.questionSnapshots;
    if (!posthog) {
...
var dismissedSurveyEvent = function (survey, posthog, readOnly, surveyLanguage) {
    ...
    var effectiveLanguage = inProgressSurvey ? inProgressSurvey.surveyLanguage : surveyLanguage;
    posthog.capture(posthog_surveys_types_1.SurveyEventName.DISMISSED, __assign(__assign(__assign({}, _buildSurveyEventProperties(survey, inProgressSurvey, posthog)), (effectiveLanguage && (_a = {}, _a[posthog_surveys_types_1.SurveyEventProperties.SURVEY_LANGUAGE] = effectiveLanguage, _a))), { $set: (_b = {},
...
var hasBranching = function (survey) { return survey.questions.some(function (question) { var _a; return !!((_a = question.branching) === null || _a === void 0 ? void 0 : _a.type); }); };
/**
 ...
 */
var restorePersistedOrder = function (survey, questionOrder) {
    var e_1, _a;
    if (!questionOrder || questionOrder.length !== survey.questions.length) {
        return null;
    }
    var questionsById = new Map(survey.questions.map(function (question) { return [question.id, question]; }));
    var restored = [];
    try {
        for (var questionOrder_1 = __values(questionOrder), questionOrder_1_1 = questionOrder_1.next(); !questionOrder_1_1.done; questionOrder_1_1 = questionOrder_1.next()) {
            var id = questionOrder_1_1.value;
            var question = questionsById.get(id);
            if (!question) {
                return null;
            }
        ...
        try {
            if (questionOrder_1_1 && !questionOrder_1_1.done && (_a = questionOrder_1.return)) _a.call(questionOrder_1);
        }
...
var getQuestionOrder = function (questions) {
    var ids = questions.map(function (question) { return question.id; });
    return ids.every(function (id) { return !!id; }) ? ids : undefined;
};
exports.getQuestionOrder = getQuestionOrder;
/**
 ...
 */
var getDisplayOrderQuestions = function (survey, inProgressState) {
    var _a;
    if (hasBranching(survey)) {
        return survey.questions;
    }
    if (inProgressState) {
        return (_a = restorePersistedOrder(survey, inProgressState.questionOrder)) !== null && _a !== void 0 ? _a : survey.questions;
    }
...
var canActivateRepeatedly = function (survey) {
    return (0, surveys_1.canSurveyActivateRepeatedly)(survey) || (0, exports.isSurveyInProgress)(survey);
};
...
function doesSurveyUrlMatch(survey, posthog) {
    var _a, _b;
    ...
    var href = (0, url_targeting_utils_1.getTargetingUrl)(posthog);
    if (!href) {
        // if we dont know the url, assume it is not a match
        return false;
    }
    var targets = [survey.conditions.url];
    var matchType = defaultMatchType((_b = survey.conditions) === null || _b === void 0 ? void 0 : _b.urlMatchType);
...
var getInProgressSurveyStateKey = function (survey) {
    return (0, survey_utils_1.getSurveyStorageKey)(survey_utils_1.SURVEY_IN_PROGRESS_PREFIX, survey);
};
