...
export declare const sendSurveyEvent: ({ responses, survey, surveySubmissionId, posthog, isSurveyCompleted, properties, surveyLanguage, questionSnapshots, }: SendSurveyEventArgs) => void;
...
export declare const getQuestionOrder: (questions: SurveyQuestion[]) => string[] | undefined;
/**
 ...
 */
export declare const getDisplayOrderQuestions: (survey: Survey, inProgressState?: InProgressSurveyState | null) => SurveyQuestion[];
...
export declare function doesSurveyUrlMatch(survey: Pick<Survey, 'conditions'>, posthog?: PostHog): boolean;
