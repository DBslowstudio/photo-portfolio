...
var FBCLID_PATTERN = /^[A-Za-z0-9_-]{1,400}$/;
var FBC_PATTERN = /^fb\.[0-9]+\.[0-9]+\.[A-Za-z0-9_-]+(?:\.[A-Za-z0-9_-]+)?$/;
...
var getSessionRecordingDefaults = function (defaults) {
...
var PostHog = /** @class */ (function () {
    ...
    function PostHog() {
        ...
        this._hasStableInitialDistinctId = false;
        this._hasWarnedAboutVolatileIdentity = false;
    ...
    PostHog.prototype._removeExtension = function (extension) {
        if (!extension) {
            return;
        }
        var idx = this._extensions.indexOf(extension);
        if (idx !== -1) {
    ...
    PostHog.prototype._warnIfVolatileIdentityWithoutStableId = function () {
        ...
        var volatileIdentityPersistence = this.config.persistence === 'memory' || this.config.persistence === 'sessionStorage';
        ...
        if (volatileIdentityPersistence) {
            cause = "persistence is set to '".concat(this.config.persistence, "'");
        ...
        console.warn('[PostHog.js]', "".concat(cause, " but no bootstrap.distinctID was provided. ") +
            "PostHog will mint a new distinct ID ".concat(lifetime, ", so calling identify() merges a new ") +
            'ID onto the person each time. A person can then pass the distinct-ID limit and its events stop ' +
            "appearing on person pages and the session tab. ".concat(fix));
    };
    /**
    ...
    PostHog.prototype._init = function (token, config, name) {
        ...
        var initialDistinctId = (_c = config.bootstrap) === null || _c === void 0 ? void 0 : _c.distinctID;
        this._hasStableInitialDistinctId = !!initialDistinctId && !(0, core_1.isEmptyString)(initialDistinctId);
        if ((_d = config.bootstrap) === null || _d === void 0 ? void 0 : _d.distinctID) {
        ...
        (0, general_utils_1.addEventListener)(globals_1.window, 'pageshow', function () {
            var _a;
            _this._isPageUnloading = false;
            if (!_this._isShutdown) {
                (_a = _this._retryQueue) === null || _a === void 0 ? void 0 : _a.resume();
            }
        });
    ...
    PostHog.prototype._isSharedExtension = function (extension) {
        var sharedExtension = extension;
        return (0, core_1.isString)(sharedExtension.name) && (0, core_1.isFunction)(sharedExtension.setup);
    };
    PostHog.prototype._enrollExtension = function (extension, initTasks) {
        var _this = this;
        if (this._isSharedExtension(extension)) {
            initTasks.push(function () {
                return void _this._getBrowserClientAdapter()
                    .add(extension)
                    .catch(function () { var _a; return (_a = extension.dispose) === null || _a === void 0 ? void 0 : _a.call(extension); })
                    .catch(function (error) {
                    logger_1.logger.error("Failed to dispose browser extension \"".concat(extension.name, "\""), error);
                });
            });
        }
        else {
    ...
    PostHog.prototype._initExtensions = function (startInCookielessMode) {
        ...
        if (ext.surveys) {
            this._enrollExtension((this.surveys = (_b = this.surveys) !== null && _b !== void 0 ? _b : new ext.surveys(this)), initTasks);
        }
        if (ext.logs) {
            this._enrollExtension((this.logs = (_c = this.logs) !== null && _c !== void 0 ? _c : new ext.logs(this)), initTasks);
        }
        if (ext.metrics) {
    ...
    PostHog.prototype._send_request = function (options) {
        ...
        options.compression =
            options.compression === 'best-available'
                ? ((_c = this.compression) !== null && _c !== void 0 ? _c : options.compressionFallback)
                : options.compression;
    ...
    PostHog.prototype._getPersistedFacebookClickId = function () {
        var _a;
        var stored = (_a = this.persistence) === null || _a === void 0 ? void 0 : _a.get_property(constants_1.PERSISTENCE_FACEBOOK_CLICK_ID);
        if ((0, core_1.isString)(stored) && FBC_PATTERN.test(stored)) {
            return { value: stored, delivered: false };
        }
        if ((0, core_1.isObject)(stored) && (0, core_1.isString)(stored.value) && FBC_PATTERN.test(stored.value)) {
            return { value: stored.value, delivered: stored.delivered === true };
        }
        return undefined;
    };
    PostHog.prototype._updateFacebookClickId = function (fbclid, providedFbc, hasProvidedFbc, unsetFbc) {
        var _a, _b;
        if (!this.persistence) {
            return undefined;
        }
        this.persistence.refreshKey(constants_1.PERSISTENCE_FACEBOOK_CLICK_ID);
        var stored = this._getPersistedFacebookClickId();
        if (unsetFbc) {
            this.persistence.unregister(constants_1.PERSISTENCE_FACEBOOK_CLICK_ID);
            return undefined;
        }
        ...
        if (hasProvidedFbc) {
            if (!(0, core_1.isString)(providedFbc) || !FBC_PATTERN.test(providedFbc)) {
                this.persistence.unregister(constants_1.PERSISTENCE_FACEBOOK_CLICK_ID);
                return undefined;
            }
            if (providedFbc !== (stored === null || stored === void 0 ? void 0 : stored.value)) {
                this.persistence.register((_a = {},
                    _a[constants_1.PERSISTENCE_FACEBOOK_CLICK_ID] = { value: providedFbc, delivered: false },
                    _a));
            }
            return { value: providedFbc, pending: providedFbc !== (stored === null || stored === void 0 ? void 0 : stored.value) || !stored.delivered };
        }
        if ((0, core_1.isString)(fbclid) && FBCLID_PATTERN.test(fbclid)) {
            if ((stored === null || stored === void 0 ? void 0 : stored.value.split('.')[3]) === fbclid) {
                return { value: stored.value, pending: !stored.delivered };
            }
            var fbc = "fb.1.".concat(Date.now(), ".").concat(fbclid);
            this.persistence.register((_b = {},
                _b[constants_1.PERSISTENCE_FACEBOOK_CLICK_ID] = { value: fbc, delivered: false },
                _b));
            return { value: fbc, pending: true };
        }
        return stored ? { value: stored.value, pending: !stored.delivered } : undefined;
    };
    PostHog.prototype._markFacebookClickIdDelivered = function (value) {
        var _a;
        if (!this.persistence) {
            return;
        }
        this.persistence.refreshKey(constants_1.PERSISTENCE_FACEBOOK_CLICK_ID);
        var stored = this._getPersistedFacebookClickId();
        if ((stored === null || stored === void 0 ? void 0 : stored.value) === value && !stored.delivered) {
            this.persistence.register((_a = {},
                _a[constants_1.PERSISTENCE_FACEBOOK_CLICK_ID] = { value: value, delivered: true },
                _a));
        }
    };
    /**
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        var propertySet = (0, core_1.isObject)(properties === null || properties === void 0 ? void 0 : properties.$set) ? properties.$set : undefined;
        var hasOptionFbc = !!(options === null || options === void 0 ? void 0 : options.$set) && constants_1.FACEBOOK_CLICK_ID in options.$set;
        var hasPropertyFbc = !!propertySet && constants_1.FACEBOOK_CLICK_ID in propertySet;
        var hasProvidedFbc = hasOptionFbc || hasPropertyFbc;
        var providedFbc = hasOptionFbc ? (_e = options === null || options === void 0 ? void 0 : options.$set) === null || _e === void 0 ? void 0 : _e[constants_1.FACEBOOK_CLICK_ID] : propertySet === null || propertySet === void 0 ? void 0 : propertySet[constants_1.FACEBOOK_CLICK_ID];
        var propertyUnset = (0, core_1.isArray)(properties === null || properties === void 0 ? void 0 : properties.$unset) ? properties.$unset : [];
        var optionUnset = (options === null || options === void 0 ? void 0 : options.$unset) || [];
        var unsetFbc = propertyUnset.indexOf(constants_1.FACEBOOK_CLICK_ID) !== -1 || optionUnset.indexOf(constants_1.FACEBOOK_CLICK_ID) !== -1;
        var fbc = this._updateFacebookClickId(campaignParams === null || campaignParams === void 0 ? void 0 : campaignParams.fbclid, providedFbc, hasProvidedFbc, unsetFbc);
        if (fbc &&
            ...
            data.$set = __assign((_a = {}, _a[constants_1.FACEBOOK_CLICK_ID] = fbc.value, _a), data.$set);
        }
        ...
        if (event_name === posthog_surveys_types_1.SurveyEventName.DISMISSED || event_name === posthog_surveys_types_1.SurveyEventName.SENT) {
            ...
            data.$set = __assign(__assign({}, data.$set), (_b = {}, _b[(0, survey_utils_1.getSurveyInteractionProperty)({ id: surveyId, current_iteration: surveyIteration }, event_name === posthog_surveys_types_1.SurveyEventName.SENT ? 'responded' : 'dismissed')] = true, _b));
        }
        else if (event_name === posthog_surveys_types_1.SurveyEventName.SHOWN) {
            data.$set = __assign(__assign({}, data.$set), (_c = {}, _c[posthog_surveys_types_1.SurveyEventProperties.SURVEY_LAST_SEEN_DATE] = new Date().toISOString(), _c));
        }
        if (event_name === posthog_product_tours_types_1.ProductTourEventName.SHOWN) {
            ...
            if (tourType) {
                data.$set = __assign(__assign({}, data.$set), (_d = {}, _d["".concat(posthog_product_tours_types_1.ProductTourEventProperties.TOUR_LAST_SEEN_DATE, "/").concat(tourType)] = new Date().toISOString(), _d));
            }
        }
        ...
        var finalFbc = (_g = (_f = data.$set) === null || _f === void 0 ? void 0 : _f[constants_1.FACEBOOK_CLICK_ID]) !== null && _g !== void 0 ? _g : ((0, core_1.isObject)((_h = data.properties) === null || _h === void 0 ? void 0 : _h.$set) ? data.properties.$set[constants_1.FACEBOOK_CLICK_ID] : undefined);
        var fbcToConfirm = (fbc === null || fbc === void 0 ? void 0 : fbc.pending) && finalFbc === fbc.value ? fbc.value : undefined;
        this._internalEventEmitter.emit('eventCaptured', data);
        var url = (_j = options === null || options === void 0 ? void 0 : options._url) !== null && _j !== void 0 ? _j : this.requestRouter.endpointFor('api', this.analyticsDefaultEndpoint);
        var isSessionRecording = (options === null || options === void 0 ? void 0 : options._batchKey) === 'recordings' || /\/s\/(?:\?|$)/.test(url);
        var requestOptions = __assign(__assign(__assign({ method: 'POST', url: url, data: data, compression: 'best-available', timestampMode: isSessionRecording ? 'body' : 'capture-body', batchKey: options === null || options === void 0 ? void 0 : options._batchKey }, (isSessionRecording && ((_k = data.properties) === null || _k === void 0 ? void 0 : _k.$session_id) ? { batchGroup: data.properties.$session_id } : {})), ((options === null || options === void 0 ? void 0 : options.transport) ? { transport: options.transport } : {})), (fbcToConfirm
            ? {
                fireCallbackOnDrop: true,
                callback: function (response) {
                    if (response.statusCode >= 200 && response.statusCode < 300) {
                        _this._markFacebookClickIdDelivered(fbcToConfirm);
                    }
                },
            }
            : {}));
        ...
        if (this.config.request_batching &&
            (!options || (options === null || options === void 0 ? void 0 : options._batchKey)) &&
            !(options === null || options === void 0 ? void 0 : options.send_instantly) &&
            !fbcToConfirm) {
            ...
            if (!requestOptions.transport &&
                !requestOptions.callback &&
                (0, core_1.isEmptyObject)((_l = this.config.request_headers) !== null && _l !== void 0 ? _l : {}) &&
    ...
    PostHog.prototype.getExtension = function (name) {
        var _a;
        return (_a = this._browserClientAdapter) === null || _a === void 0 ? void 0 : _a.getExtension(name);
    };
    ...
    PostHog.prototype.calculateEventProperties = function (eventName, eventProperties, timestamp, uuid, readOnly) {
        ...
        var eventGroups = properties['$groups'];
        var persistenceGroups = persistenceProperties['$groups'];
        // An explicit empty object keeps its existing meaning: omit registered groups for this event.
        if ((0, core_1.isObject)(eventGroups) && !(0, core_1.isEmptyObject)(eventGroups)) {
            properties['$groups'] = __assign(__assign({}, ((0, core_1.isObject)(persistenceGroups) ? persistenceGroups : {})), eventGroups);
        }
    ...
    PostHog.prototype.identify = function (new_distinct_id, userPropertiesToSet, userPropertiesToSetOnce) {
        ...
        try {
            ...
            if (identityDidChange && isKnownAnonymous) {
                var identifyProperties = this.config.reuseAnonymousId
                ...
                this.capture(constants_1.EVENT_IDENTIFY, identifyProperties, {
                ...
                (_a = this.featureFlags) === null || _a === void 0 ? void 0 : _a.setAnonymousDistinctId(this.config.reuseAnonymousId ? undefined : previous_distinct_id);
            }
    ...
    PostHog.prototype._reset = function (reset_device_id, isConsentTransition, bootstrap) {
        ...
        (_f = this.sessionRecording) === null || _f === void 0 ? void 0 : _f.flushBeforeIdentityReset();
        ...
        var cookieSyncSuppressionStarted = (_h = (_g = this.persistence) === null || _g === void 0 ? void 0 : _g._beginCookieSyncSuppression) === null || _h === void 0 ? void 0 : _h.call(_g);
        var resetCompleted = false;
        try {
            (_j = this.persistence) === null || _j === void 0 ? void 0 : _j.clear();
            (_k = this.sessionPersistence) === null || _k === void 0 ? void 0 : _k.clear();
            this._sessionRegisteredPropKeys.clear();
            this._persistSessionRegisteredPropKeys();
            if (!(0, core_1.isUndefined)(recordingRemoteConfig)) {
                (_l = this.persistence) === null || _l === void 0 ? void 0 : _l.register((_a = {}, _a[constants_1.SESSION_RECORDING_REMOTE_CONFIG] = recordingRemoteConfig, _a));
            }
            (_m = this.surveys) === null || _m === void 0 ? void 0 : _m.reset();
            ...
            if (bootstrap) {
                ...
                if (!(0, core_1.isNullish)(bootstrapSessionID) &&
    ...
    PostHog.prototype.shutdown = function (_shutdownTimeoutMs) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_j) {
                ...
                (_a = this.sessionRecording) === null || _a === void 0 ? void 0 : _a.dispose();
                ...
                void ((_c = this.metrics) === null || _c === void 0 ? void 0 : _c.flush('sendBeacon'));
                (_d = this._requestQueue) === null || _d === void 0 ? void 0 : _d.unload();
                (_e = this._retryQueue) === null || _e === void 0 ? void 0 : _e.unload();
                try {
                    (_f = this.featureFlags) === null || _f === void 0 ? void 0 : _f.destroy();
                }
                catch (error) {
                    logger_1.logger.error('Error while destroying feature flags', error);
                }
                (_g = this.persistence) === null || _g === void 0 ? void 0 : _g.destroy();
                (_h = this.sessionPersistence) === null || _h === void 0 ? void 0 : _h.destroy();
                return [2 /*return*/];
            });
        });
    };
    ...
    PostHog.prototype.set_config = function (config) {
        ...
        if ((0, core_1.isObject)(config)) {
            ...
            if ('capture_pageview' in config || 'disable_capture_url_hashes' in config) {
                (_k = this.historyAutocapture) === null || _k === void 0 ? void 0 : _k.startIfEnabledOrStop();
            }
            (_l = this.exceptionObserver) === null || _l === void 0 ? void 0 : _l.startIfEnabledOrStop();
            (_m = this.deadClicksAutocapture) === null || _m === void 0 ? void 0 : _m.startIfEnabledOrStop();
            (_o = this.surveys) === null || _o === void 0 ? void 0 : _o.loadIfEnabled();
            this._sync_opt_out_with_persistence();
            (_p = this.externalIntegrations) === null || _p === void 0 ? void 0 : _p.startIfEnabledOrStop();
            if (!oldConfig.segment && this.config.segment && this.persistence) {
                (0, segment_integration_1.setupSegmentIntegration)(this, __NOOP, false);
            }
        }
    };
    /**
    ...
    PostHog.prototype._sync_opt_out_with_persistence = function () {
        ...
        if (!this.is_capturing()) {
            (_a = this.logs) === null || _a === void 0 ? void 0 : _a._onOptOut();
        }
        if (((_b = this.persistence) === null || _b === void 0 ? void 0 : _b._disabled) !== persistenceDisabled) {
            (_c = this.persistence) === null || _c === void 0 ? void 0 : _c.set_disabled(persistenceDisabled);
        }
        if (((_d = this.sessionPersistence) === null || _d === void 0 ? void 0 : _d._disabled) !== persistenceDisabled) {
            (_e = this.sessionPersistence) === null || _e === void 0 ? void 0 : _e.set_disabled(persistenceDisabled);
        }
    ...
    PostHog.prototype.opt_in_capturing = function (options) {
        ...
        if (this._inCookielessMode()) {
            ...
            (_a = this.sessionRecording) === null || _a === void 0 ? void 0 : _a.dispose({ discardBufferedEvents: true });
            ...
            var SessionRecordingClass = (_e = (_d = this.config.__extensionClasses) === null || _d === void 0 ? void 0 : _d.sessionRecording) !== null && _e !== void 0 ? _e : (_f = PostHog.__defaultExtensionClasses) === null || _f === void 0 ? void 0 : _f.sessionRecording;
            if (SessionRecordingClass) {
                ...
                if (this._lastRemoteConfig) {
                    (_h = (_g = this.sessionRecording) === null || _g === void 0 ? void 0 : _g.onRemoteConfig) === null || _h === void 0 ? void 0 : _h.call(_g, this._lastRemoteConfig);
                }
            }
        }
        ...
        (_j = this.sessionRecording) === null || _j === void 0 ? void 0 : _j.startIfEnabledOrStop();
        ...
        if ((0, core_1.isUndefined)(options === null || options === void 0 ? void 0 : options.captureEventName) || (options === null || options === void 0 ? void 0 : options.captureEventName)) {
            this.capture((_l = options === null || options === void 0 ? void 0 : options.captureEventName) !== null && _l !== void 0 ? _l : '$opt_in', options === null || options === void 0 ? void 0 : options.captureProperties, { send_instantly: true });
        }
        if (this.config.capture_pageview) {
    ...
    PostHog.prototype.opt_out_capturing = function () {
        ...
        var sessionRecording = this.config.cookieless_mode === constants_1.COOKIELESS_ON_REJECT ? this.sessionRecording : undefined;
        // Identity changes must not let queued recorder work flush under the cookieless identity.
        sessionRecording === null || sessionRecording === void 0 ? void 0 : sessionRecording.dispose({ discardBufferedEvents: true });
