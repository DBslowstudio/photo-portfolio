...
export declare class PostHog implements PostHogInterface {
    ...
    private _hasStableInitialDistinctId;
    private _hasWarnedAboutVolatileIdentity;
    private _removeExtension;
    private _replaceExtension;
    private _inCookielessMode;
    private _warnIfVolatileIdentityWithoutStableId;
    /**
    ...
    private _isSharedExtension;
    private _enrollExtension;
    ...
    private _getPersistedFacebookClickId;
    private _updateFacebookClickId;
    private _markFacebookClickIdDelivered;
    /**
