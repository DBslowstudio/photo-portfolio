...
var RequestQueue = /** @class */ (function () {
    ...
    RequestQueue.prototype.unload = function () {
        ...
        sortedRequests.map(function (req) {
            _this._sendRequestSafely(__assign(__assign({}, req), { transport: 'sendBeacon' }));
        });
    };
        ...
        this._flushTimeout = setTimeout(function () {
            ...
            if (_this._queue.length > 0) {
                ...
                for (var key in requests) {
                    _this._sendRequestSafely(requests[key]);
                }
            }
        }, this._flushTimeoutMs);
    };
    RequestQueue.prototype._sendRequestSafely = function (req) {
        try {
    ...
    RequestQueue.prototype._formatQueue = function () {
        var requests = {};
        (0, general_utils_1.each)(this._queue, function (request) {
            var _a;
            var req = request;
            var key = ((req ? req.batchKey : null) || req.url) + (req.batchGroup ? ":".concat(req.batchGroup) : '');
